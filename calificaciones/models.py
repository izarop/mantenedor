...
class CalificacionEncabezado(models.Model):
    ...
    evento_capital = models.PositiveIntegerField(null=True, blank=True)
    valor_historico = models.PositiveIntegerField(null=True, blank=True)
    fecha_pago = models.DateField()
    secuencia_evento = models.PositiveIntegerField(null=True,blank=True)
    anio = models.IntegerField(null=True,blank=True)
    factor_actualizacion = models.PositiveIntegerField( null=True,blank=True)
